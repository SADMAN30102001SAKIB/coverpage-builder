...
async function fetch_lab(){
    if(savedLab){
        ...
        const response = await fetch("https://cse-coverpage.netlify.app/server/LabCover.pdf");
        if (response.ok) {
...
async function fetch_lab_group(){
    if(savedLab){
        ...
        const response = await fetch("https://cse-coverpage.netlify.app/server/LabGroupCover.pdf");
        if (response.ok) {
